...
public class App {
  ...
  public App id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public App dnsName(@jakarta.annotation.Nullable String dnsName) {
  ...
  public App description(@jakarta.annotation.Nullable String description) {
  ...
  public App path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, app.id) &&
        ...
        Objects.equals(this.dnsName, app.dnsName) &&
        Objects.equals(this.description, app.description) &&
        Objects.equals(this.path, app.path);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, displayName, dnsName, description, path);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "displayName", "dnsName", "description", "path"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!App.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in App is not found in the empty JSON string", App.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!App.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `App` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
