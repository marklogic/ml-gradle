...
public class Type {
  ...
  public Type memberType(@jakarta.annotation.Nullable MemberTypes memberType) {
  ...
  public Type assembly(@jakarta.annotation.Nullable Assembly assembly) {
  ...
  public Type module(@jakarta.annotation.Nullable Module module) {
    this.module = module;
    return this;
  }
  ...
  public Type declaringType(@jakarta.annotation.Nullable Type declaringType) {
  ...
  public Type declaringMethod(@jakarta.annotation.Nullable MethodBase declaringMethod) {
  ...
  public Type reflectedType(@jakarta.annotation.Nullable Type reflectedType) {
  ...
  public Type underlyingSystemType(@jakarta.annotation.Nullable Type underlyingSystemType) {
  ...
  public Type genericParameterAttributes(@jakarta.annotation.Nullable GenericParameterAttributes genericParameterAttributes) {
  ...
  public Type attributes(@jakarta.annotation.Nullable TypeAttributes attributes) {
  ...
  public Type structLayoutAttribute(@jakarta.annotation.Nullable StructLayoutAttribute structLayoutAttribute) {
  ...
  public Type typeInitializer(@jakarta.annotation.Nullable ConstructorInfo typeInitializer) {
  ...
  public Type typeHandle(@jakarta.annotation.Nullable RuntimeTypeHandle typeHandle) {
  ...
  public Type baseType(@jakarta.annotation.Nullable Type baseType) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Type.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Type is not found in the empty JSON string", Type.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Type.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Type` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
