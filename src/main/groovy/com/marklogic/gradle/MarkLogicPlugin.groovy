...
import com.marklogic.gradle.task.roxy.RoxyGenerateTestSuiteTask
...
class MarkLogicPlugin implements Plugin<Project> {
	...
	void apply(Project project) {
        ...
        project.task("mlRoxyGenerateTestSuite", type: RoxyGenerateTestSuiteTask, group: roxyGroup, description: "Generate a Roxy test suite.", dependsOn: [])
